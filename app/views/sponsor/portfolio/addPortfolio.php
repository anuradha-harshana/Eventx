...
<div class="portfolio-form-container">
    <div class="form-header">
        ...
        <p>Showcase your brand and past sponsorship collaborations</p>
    </div>

    <form method="POST" action="<?php echo SITE_URL; ?>sponsor/createPortfolio" enctype="multipart/form-data">
        <!-- Title -->
        <div class="form-group">
            <label for="title" class="required">Portfolio Item Title</label>
            <input type="text" id="title" name="title" placeholder="e.g., Tech Summit 2024 Sponsorship"
        ...
        <div class="form-group">
            ...
            <textarea id="brand_description" name="brand_description"
                      placeholder="Describe your brand's involvement, achievements, and impact from this sponsorship..."
                      required></textarea>
        ...
        <div class="form-group">
            ...
            <input type="text" id="past_collaboration" name="past_collaboration"
                   placeholder="e.g., Event organized with ABC Company">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" id="event_name" name="event_name"
                       placeholder="e.g., International Tech Summit">
        ...
        <div class="file-upload-group">
            ...
            <div class="file-upload" onclick="document.getElementById('logo').click()">
                ...
                <label>Logo</label>
                <div class="upload-text">Click to upload your brand logo</div>
                <span style="font-size: 11px; color: #999;">JPG, PNG, GIF (Max 2MB)</span>
            </div>
            ...
            <div class="file-upload" onclick="document.getElementById('banner').click()">
                ...
                <label>Banner</label>
                <div class="upload-text">Click to upload event/collaboration banner</div>
                <span style="font-size: 11px; color: #999;">JPG, PNG, GIF (Max 2MB)</span>
            </div>
            ...
            <div class="file-upload" onclick="document.getElementById('image').click()">
                ...
                <span class="upload-icon">📸</span>
                <label>Image</label>
                <div class="upload-text">Click to upload portfolio image</div>
                <span style="font-size: 11px; color: #999;">JPG, PNG, GIF (Max 2MB)</span>
            </div>
        </div>
